...
class Customer:
    ...
    def gather_coins_from_wallet(self, selected_soda):
        ...
        while will_proceed == False: #previously just will proceed
            ...
            if coin_name == "Done": #now capiltalized to match other use of string as a comparisson
                break
    ...
    def check_coins_in_wallet(self):
        ...
        for coin in self.wallet.money:
            total_value += coin.value #this crashes if you check wallet after a purchase
